...
![نمای فروشگاه مبین سیلور](qa/storefront-v3-desktop.png)

## وضعیت پروژه

این مخزن یک نسخه عملیاتی و قابل‌توسعه از فروشگاه مبین سیلور است و بخش‌های فروشگاه عمومی، احراز هویت، سبد خرید، ثبت درخواست سفارش، داشبورد مشتری و داشبورد مدیریت را در بر می‌گیرد. درگاه پرداخت آنلاین در نسخه فعلی پیاده‌سازی نشده است؛ سفارش با روش صریح «پرداخت پس از تأیید کارشناس» ثبت می‌شود. پیامک، قیمت لحظه‌ای فلزات و شرکت حمل‌ونقل نیز اتصال بیرونی واقعی ندارند و پیش از فروش واقعی باید با سرویس‌های دارای مجوز یکپارچه شوند.
...
- لغو سفارش در وضعیت «در انتظار بررسی» همراه با بازگردانی موجودی
- داشبورد مشتری شامل تاریخچه سفارش‌ها، وضعیت آخرین سفارش، علاقه‌مندی‌ها، نشانی، حساب کاربری و تغییر رمز
- خبرنامه واقعی با جلوگیری از ثبت ایمیل تکراری
- مجله تخصصی با ۲۰ مقاله کامل، جستجو، دسته‌بندی، مقاله ویژه، فهرست مطالب و مطالب مرتبط

### مدیریت

- داشبورد آماری فروش، سفارش‌ها، مشتریان و محصولات کم‌موجود
- نمودار فروش هفتگی و نمایش قیمت و موجودی فلزات
- فهرست، ایجاد، ویرایش و حذف کنترل‌شده محصول
- جستجو و فیلتر سفارش‌ها، تغییر وضعیت کنترل‌شده و بازگردانی موجودی هنگام لغو
- مشاهده فهرست مشتریان
- تنظیمات پایدار نام فروشگاه، راه ارتباطی، اعلان بالای سایت و فعال/غیرفعال‌کردن سفارش
- خروجی CSV سفارش‌ها و مرکز اعلان‌های مدیریتی
