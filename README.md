...
فروشگاه اینترنتی فارسی و راست‌چین برای عرضه شمش نقره، زیورآلات نقره و شمش طلا؛ توسعه‌یافته با ASP.NET Core، React، TypeScript و SQLite.
