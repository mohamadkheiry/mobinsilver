...
| [گزارش رگرسیون و سخت‌سازی v4](quality-cycles-v4.md) | محصول، QA و توسعه | اصلاحات امنیتی/رفتاری و شواهد ۱۶ سناریوی رگرسیون |
| [گزارش پنج چرخه کیفیت v3](quality-cycles-v3.md) | محصول، QA و توسعه | تغییرات، خطاهای کشف‌شده، شواهد و معیار انتشار |
