...
- حذف حساب و رمز seed پیش‌فرض یا اجبار تغییر در نخستین ورود
- انتقال کلید JWT به Secret Manager و rotation دوره‌ای
- validation جامع مدل‌های ورودی و محدودیت طول/قالب
- rate limit برای login، register، سفارش و endpointهای حساس
- lockout یا تأخیر افزایشی برای تلاش ورود ناموفق
...
- soft delete و کنترل ارجاع محصول دارای سفارش
- transition whitelist برای وضعیت سفارش
- optimistic concurrency برای موجودی
