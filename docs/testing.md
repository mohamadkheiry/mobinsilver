...
آخرین اجرای محلی نسخه v3 در ۱۰ سناریو، `10 passed` گزارش کرده است. پوشش فعلی شامل پوسته فروشگاه، وبلاگ، موبایل، مدیریت مقاله، خبرنامه، جریان سفارش مشتری، ویرایش/تنظیمات/CSV مدیر، کنترل overflow، validation API و throttle ورود است. جزئیات چرخه‌ها در [گزارش کیفیت v3](quality-cycles-v3.md) آمده است.
